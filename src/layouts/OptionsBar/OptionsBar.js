        ...
        <section className={styles.optionsBar}>
            <div className={styles.optionsBarHolder}>
                <div className={styles.socialLinksBox}>
                    <a className={styles.optSocialLink} href='https://www.instagram.com/napetico' target='_blank' rel="noreferrer">
                        <img className={styles.optSocialLinkImage} src='./images/napo-instagram-logo.svg' alt=''/>
                    </a>
                    <a className={styles.optSocialLink} href='https://www.linkedin.com/in/napoleon-bazan/' target='_blank' rel="noreferrer">
                        <img className={styles.optSocialLinkImage} src='./images/napo-linkedin-logo.svg' alt=''/>
                    </a>
                    <a className={styles.optSocialLink} href='https://github.com/napetico' target='_blank' rel="noreferrer">
